...
def run_nemo_gym_rollout_sync(
    ...
    Raises:
        ...
        ValueError: If ``num_generations_per_prompt`` is omitted, or streamed rows
            violate the ordering, uniqueness, grouping, or task-index invariants
            documented by :func:`run_async_nemo_gym_rollout`.
    ...
    if num_generations_per_prompt is None:
        raise ValueError("num_generations_per_prompt must be provided explicitly")
